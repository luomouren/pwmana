...
public class WechatPayControler extends BaseControler {
	...
	/*
	 * web.jsp实现的是微信公众号调起支付的功能
	 * */
	@RequestMapping("/openWebPay")
	public String openWebPay(HttpServletRequest request,Model model){
		return "/wechatpay/web";
	}
	
	/*
	 * native.jsp是实现了PC端扫二维码的功能
	 * */
	@RequestMapping("/openNativePay")
	public String openNativePay(HttpServletRequest request,Model model){
